            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12  text-primary-inicial " >
                        <h2 class="text-primary-inicial text-center">Consulta de Manutenção de Equipamento</h2>
                        <br>
                        <br>
                        <a><% if (message != null) {
                                out.print(message);
                        ...
                        <form role="form" action="Controller_Maintenance.jsp" method="post">
                                ...
                                <tr>
                                    <td width="1000" id="coluna-1" >
                                        <div class="form-group">
                                            <div class="col-sm-2">
                                                <button type="submit" class="btn btn-primary" name="Command" value="consult_search">Buscar</button>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-30">
                                                <input type="Text" class="form-control form-control2" name="SN"  <% if (returnn != null) {%>value="<%out.print((String) session.getAttribute("field2"));%>"<%}%>>
                                            </div>
                                        </div><br>
                                        <div class="form-group">
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-30">
                                                <input type="Text" class="form-control form-control2" name="Date"  <% if (returnn != null) {%>value="<%out.print((String) session.getAttribute("field3"));%>"<%}%>>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-30">
                                                <input type="Text" class="form-control form-control2" name="Problem"  <% if (returnn != null) {%>value="<%out.print((String) session.getAttribute("field4"));%>"<%}%>>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-30">
                                                <input type="Text" class="form-control form-control2" name="Solution"  <% if (returnn != null) {%>value="<%out.print((String) session.getAttribute("field5"));%>"<%}%>>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <div class="section">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <button type="submit" class="btn btn-primary" name="Command" value="consult_save">Salvar</button>
                                        </div>
                                        <%// if (usuario != null && usuario.equals("admin")) {%>
                                        <div class="col-md-3">
                                            <a href="View_Consult_Maintenance.jsp" class="btn btn-primary">Limpar</a>
                                        </div>
                                        <div class="col-md-3">
                                            <button class="btn btn-primary" name="Command" value="consult_edit">Atualizar</button>
                                        </div>
                                        <div class="col-md-3">
                                            <button class="btn btn-primary" name="Command" value="consult_delete">Excluir</button>
                                        </div><%//}%>
                                    </div>
                                </div>
                            </div>
