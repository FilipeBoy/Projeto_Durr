            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12  text-primary-inicial width-form" >
                        <h2 class="text-primary-inicial text-center">Atualização do Status de Equipamento na Manutenção</h2>
                        <br>
                        <br>
                        <a><% if (mensagem != null) {
                                out.print(mensagem);
                        ...
                        <form role="form" action="ControllerCurso.jsp" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-30" width="10">
                                    <input type="text" class="form-control form-control2" name="busca" placeholder="Digite o código de registro da manutenção">
                                </div>
                            </div><br><br><br><br>
                            <div class="form-group">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-30">
                                    <input type="Text" class="form-control form-control2" name="SN" placeholder="Somente números"  <% if (retorno != null) {%>value="<%out.print((String) session.getAttribute("campo1"));%>"<%}%>>
                                </div>
                            </div><br>
                            <div class="form-group">
                                <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-30">
                                    <select name="Status">
                                        ...
                                        <option value="Wait_Maint">Aguardando Manutenção</option>
                                        <option value="Wait_budget">Aguardando Aprovação Orçamento</option>
