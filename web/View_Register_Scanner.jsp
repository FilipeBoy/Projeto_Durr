...
<%String user = (String) session.getAttribute("Name");
    ...
    String message = (String) session.getAttribute("Message");
        String option = null;
   if (returnn != null) {
        option = (String) session.getAttribute("field1");
    } 
    List<MODEL.Model_Equipment> modelEquipList=null;
...
<html><head>
        ...
        <div class="cover">
            <div class="cover-image" style="background-image : url('/Projeto_Durr/Images/imagem1.jpg')" ></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12  text-primary-inicial width-form" >
                        <h2 class="text-primary-inicial text-center"><% if (returnn != null) {%>Atualização de Scanner<%}else{%>Cadastro de Scanner<%}%></h2>
                        <br>
                        <br>
                        <a><% if (message != null) {
                                out.print(message);
                        ...
                        <form role="form" action="Controller_Equipment.jsp" method="post">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <button type="submit" class="btn btn-primary" name="Command" value="search">Buscar</button>
                                </div>
                                <div class="col-sm-30" width="10">
                                    <input type="text" class="form-control form-control2" name="search" placeholder="Digite o SN do scanner">
                                </div>
                            </div><br><br><br><br>
                            <div class="form-group">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-30">
                                   <select name="Model">
                                    ...
                                    <option selected value="<%=model.getName()%>"><%=model.getName()%></option>
                                    <%} else {%>
                                    ...
                                    <option value=""></option>
                                    <%for (Model_Equipment depto : modelEquipList) {%>   
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                <div class="col-sm-2">
                                    <label for="CodUnid" class="control-label">Código Unid. Clinica</label>
                                </div>
                                <div class="col-sm-30">
                                    <input type="number" class="form-control form-control2" name="CodUnid" placeholder="0" <% if (returnn != null) {%>value="<%out.print(Integer.parseInt(session.getAttribute("field3").toString()));%>"<%}%>>
                                </div>
                            </div>
                            <div class="section">
                                <div class="container">
