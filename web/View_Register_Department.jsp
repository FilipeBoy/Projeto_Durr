            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12  text-primary-inicial width-form" >
                        <h2 class="text-primary-inicial text-center"><% if (returnn != null) {%>Atualização de Departamento<%}else{%>Cadastro de Departamento<%}%></h2>
                        <br>
                        <br>
                        <a><% if (message != null) {
                                out.print(message);
                            }%></a>
                        <form role="form" action="Controller_Department.jsp" method="post">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <button type="submit" class="btn btn-primary" name="Command" value="search">Buscar</button>
                                </div>
                                <div class="col-sm-30" width="10">
                                    <input type="number" class="form-control form-control2" name="search" placeholder="Digite o código do departamento" >
                                </div>
                            </div><br><br><br><br>
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <label for="CodDepto" class="control-label">Código<br>Departamento</label>
                                </div>
                                <div class="col-sm-30">
                                    <input type="number" class="form-control form-control2" name="CodDepto" placeholder="Somente números"  <% if (returnn != null) {%>value=<%out.print(Integer.parseInt(session.getAttribute("field1").toString()));%><%}%>>
                                </div>
                            </div><br>
                            <div class="form-group">
                                <div class="col-sm-2">
                            ...
                            <div class="section">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a href="View_Register_Department.jsp" class="btn btn-primary">Limpar</a>
                                        </div>
                                        <div class="col-md-3">
...
<%session.setAttribute("Returnn_Wait", null);%>ull);%>
